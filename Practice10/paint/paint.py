...
def draw_preview(screen, tool, start, end, color, width):
    ...
    if tool == "rectangle":
        ...
        radius = int(math.hypot(preview_end[0] - preview_start[0], preview_end[1] - preview_start[1]))
        if radius > 0:
            pygame.draw.circle(screen, color, preview_start, radius, width=max(1, width))
